...
export const Search = component$(() => {
  return (
    <div class="p-6 mx-4 lg:mx-auto max-w-7xl flex flex-col lg:flex-row justify-between items-center gap-4 lg:gap-x-3 relative lg:-top-8 lg:shadow-lg bg-white lg:bg-white/20 lg:backdrop-blur rounded-xl">
      <select
      ...
      <button class="bg-violet-700 hover:bg-violet-800 transition w-full lg:w-1/2 lg:max-w-[162px] h-14 rounded flex justify-center items-center text-white text-lg">
        <div>
